...
<html>
	...
	<style type="text/css">
		...
		#header .nav-top {
			...
			height: 65px;
			background: rgba(58,72,82, 1);
			box-shadow: 0px 0px 0px 0px rgba(198,161,106,3);
		...
		#header .navs li {
			...
			border-width: 6px ;
			border-style: dashed ;
			border-color: rgba(198, 161, 106, 1);
			background-color: rgba(65, 100, 131, 1);
		...
		#header .navs li:hover {
			color: rgba(198, 161, 106, 1);
			font-size: 14px;
			border-radius: 0px;
			border-width: 5px ;
			border-style: dashed;
			border-color: rgba(198, 161, 106, 1);
			background-color: rgba(52, 80, 105, 1);
	...
	<body>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"5px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"180px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(58, 72, 82, 3)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="company"></div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="record"></div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"5px auto ","borderColor":"rgba(198, 161, 106, 1)","backgroundColor":"rgba(58, 72, 82, 3)","color":"rgba(198, 161, 106, 1)","textAlign":"center","borderRadius":"0","borderWidth":"2px 0","width":"50%","lineHeight":"25px","fontSize":"14px","borderStyle":"solid"}' class="desc">Welcome</div>
		</div>
