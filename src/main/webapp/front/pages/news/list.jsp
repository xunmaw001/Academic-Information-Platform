...
<html>
	...
	<body>
		...
		<div id="app">
			<!-- 轮播图 -->
			<div class="layui-carousel" id="test1" :style='{"boxShadow":"0 0 0px rgba(110,22,64,0)","margin":"0px auto ","borderColor":"rgba(240, 240, 240, 1)","borderRadius":"0px","borderWidth":"0","width":"100%","borderStyle":"solid"}'>
			  <div carousel-item>
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"5px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"5px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0px","alignItems":"center","borderWidth":"0px","fontSize":"18px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>新闻资讯</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"5px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255,255,255,1)","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"5px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(230, 186, 89, 1)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					...
					<!-- 样式一 -->
					<div class="list">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='3'?'list-item3':3=='5'?'list-item5':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(198, 161, 106,.8)","margin":"0px 0 10px 0","borderColor":"rgba(230, 186, 89, 1)","backgroundColor":"#fff","borderRadius":"20px","borderWidth":"10px 0px 10px 0px","borderStyle":"ridge"}'>
								<img :style='{"boxShadow":"0 0 6px rgba(198, 161, 106,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"280px","borderStyle":"solid","height":"200px"}' :src="baseurl+item.picture">
								<div class="info">
									<div v-if="true" :style='{"isshow":true,"padding":"0px 0","margin":"5px 0 0 0","backgroundColor":"rgba(199, 21, 133, 0)","color":"rgba(24, 2, 2, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.title}}</div>
								</div>
							</div>
						</div>
					</div>
