...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210813/368d35f055154c5fbc870ac8c9e1fe15.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		border-width: 4px;
		border-style: solid;
		border-color: rgba(136, 109, 39, 1);
		background-color: rgba(231, 237, 216, 0.8);
	...
	#login-wrapper h1 {
		...
		background-color: rgba(191, 135, 20, 1);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		text-align: center;
	}
	...
	#registerForm button.pull-right {
		...
		border-style: solid;
		border-color: #ccc;
		background-color: rgba(191, 135, 20, 0.8);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	}
