...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>课程一</label>
										<input name="kechengyi" id="kechengyi" name="kechengyi" class="form-control" placeholder="课程一">
									</div>
									<div class="form-group col-md-6">
										<label>课程二</label>
										<input name="kechenger" id="kechenger" name="kechenger" class="form-control" placeholder="课程二">
									</div>
									<div class="form-group col-md-6">
										<label>课程三</label>
										<input name="kechengsan" id="kechengsan" name="kechengsan" class="form-control" placeholder="课程三">
									</div>
									<div class="form-group col-md-6">
										<label>课程四</label>
										<input name="kechengsi" id="kechengsi" name="kechengsi" class="form-control" placeholder="课程四">
									</div>
									<div class="form-group col-md-6">
										<label>课程五</label>
										<input name="kechengwu" id="kechengwu" name="kechengwu" class="form-control" placeholder="课程五">
									</div>
									<div class="form-group col-md-6">
										<label>课程六</label>
										<input name="kechengliu" id="kechengliu" name="kechengliu" class="form-control" placeholder="课程六">
									</div>
									<div class="form-group col-md-6">
										<label>工号</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#kechengyi").val(ruleForm.kechengyi);	
			$("#kechenger").val(ruleForm.kechenger);	
			$("#kechengsan").val(ruleForm.kechengsan);	
			$("#kechengsi").val(ruleForm.kechengsi);	
			$("#kechengwu").val(ruleForm.kechengwu);	
			$("#kechengliu").val(ruleForm.kechengliu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.kechengyi != null && res.data.kechengyi != ''){

						$("#kechengyi").val(res.data.kechengyi);
						$("#kechengyi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kechenger != null && res.data.kechenger != ''){

						$("#kechenger").val(res.data.kechenger);
						$("#kechenger").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kechengsan != null && res.data.kechengsan != ''){

						$("#kechengsan").val(res.data.kechengsan);
						$("#kechengsan").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kechengsi != null && res.data.kechengsi != ''){

						$("#kechengsi").val(res.data.kechengsi);
						$("#kechengsi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kechengwu != null && res.data.kechengwu != ''){

						$("#kechengwu").val(res.data.kechengwu);
						$("#kechengwu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kechengliu != null && res.data.kechengliu != ''){

						$("#kechengliu").val(res.data.kechengliu);
						$("#kechengliu").attr('readonly','readonly');
					}
