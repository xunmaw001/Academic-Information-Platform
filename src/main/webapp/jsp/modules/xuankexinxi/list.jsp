...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">选课信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>选课信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">选课信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="kechengleixingSearch" class="form-control form-control-sm" placeholder="请输入课程类型" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('renshu')">人数<i id="renshuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xuankeshuoming')">选课说明<i id="xuankeshuomingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('caozuoshijian')">操作时间<i id="caozuoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#kechengleixingSearch').val() != null && $('#kechengleixingSearch').val() != ''){
				searchForm.kechengleixing ="%" +  $('#kechengleixingSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var renshuCell  = document.createElement('td');

						 renshuCell.innerHTML = item.renshu;

			row.appendChild(renshuCell);
			var xuankeshuomingCell  = document.createElement('td');

						 xuankeshuomingCell.innerHTML = item.xuankeshuoming;

			row.appendChild(xuankeshuomingCell);
			var caozuoshijianCell  = document.createElement('td');

						  caozuoshijianCell.innerHTML = item.caozuoshijian;


			row.appendChild(caozuoshijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xuankexinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xuankexinxi");
