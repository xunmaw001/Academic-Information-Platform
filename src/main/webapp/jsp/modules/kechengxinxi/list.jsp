...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "选课"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'xuankexinxi','','','')");
			if(crossBtnControl('选课') == true){
	...
	function discussList(id) {
            ...
            window.location.href = "../discusskechengxinxi/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
